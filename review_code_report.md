...
Injection vulnerabilities: SQL injection at lines 75 and 284, command injection at lines 123-125, prompt injection at lines 264-270. 
...
Credential exposure and hardcoded secrets: lines 26-27, 244-245, 293. 
...
Information disclosure: lines 102, 106, 108, 158, 233 return internal paths or raw errors to clients. 
Fix: return generic errors to users and log details server-side.

Weak hash for document IDs: line 142 uses MD5, which is predictable and collision-prone. 
